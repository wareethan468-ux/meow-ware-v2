...
class Config:
    ...
    DEFAULT_SETTINGS = {
        "auto_apply": True,
        # Continuously discover RobloxPlayerBeta processes, including clients
        # that were already running before Vellium opened. Does not launch Roblox.
        "continuous_instance_detection": True,
        "window_width": 1380,
        "window_height": 780,
        ...
        # Show internal Roblox function offsets alongside FFlags.hpp entries in Discovery.
        "include_roblox_offsets_in_discovery": False,
        "roblox_build_install_root": "",
